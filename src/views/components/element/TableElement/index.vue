...
// Update table edit mode. Disable global shortcuts when table is in edit mode
...
// Watch table element size changes: when height changes, update height in state.
...
// Update currently selected cells in the table
