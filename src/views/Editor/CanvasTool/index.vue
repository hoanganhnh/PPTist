<template>
  <div class="canvas-tool">
    <div class="left-handler">
      ...
      <div class="more">
        ...
        <Popover class="more-icon" trigger="click" v-model:value="moreVisible" :offset="10">
          <template #content>
            <PopoverMenuItem class="popover-menu-item" center @click="toggleNotesPanel(); moreVisible = false"><i-icon-park-outline:comment class="icon" />Annotation Panel</PopoverMenuItem>
        ...
        <span class="handler-item" :class="{ 'active': showNotesPanel }" v-tooltip="'Annotation Panel'" @click="toggleNotesPanel()">
    ...
    <div class="add-element-handler">
      <div class="insert-handler-item group-btn" :class="{ 'active': creatingElement?.type === 'text' }" v-tooltip="'InsertText'">
        ...
        <Popover trigger="click" v-model:value="textTypeSelectVisible" style="height: 100%;" :offset="10">
          <template #content>
            <PopoverMenuItem center @click="() => { drawText(); textTypeSelectVisible = false }"><i-icon-park-outline:text-rotation-none class="icon" /> LandscapeText Box</PopoverMenuItem>
      ...
      <div class="insert-handler-item group-btn" :class="{ 'active': creatingCustomShape || creatingElement?.type === 'shape' }" v-tooltip="'InsertShape'" :offset="10">
      ...
      <div class="insert-handler-item group-btn" v-tooltip="'InsertImage'">
        ...
        <Popover trigger="click" v-model:value="imageMenuVisible" style="height: 100%;" :offset="10">
          <template #content>
            ...
            <PopoverMenuItem center @click="openImageLibPanel(); imageMenuVisible = false"><i-icon-park-outline:picture class="icon" /> Online Image Library</PopoverMenuItem>
          </template>
          <span class="arrow"><i-icon-park-outline:down /></span>
        </Popover>
      </div>
      <Popover trigger="click" v-model:value="linePoolVisible" :offset="10">
        ...
        <div class="insert-handler-item" :class="{ 'active': creatingElement?.type === 'line' }" v-tooltip="'InsertLine'">
      ...
      <Popover trigger="click" v-model:value="chartPoolVisible" :offset="10">
        ...
        <div class="insert-handler-item" v-tooltip="'InsertChart'">
      ...
      <Popover trigger="click" v-model:value="tableGeneratorVisible" :offset="10">
        ...
        <div class="insert-handler-item" v-tooltip="'InsertTable'">
          <i-icon-park-outline:insert-table class="icon" /> <span class="text">Table</span>
        </div>
      </Popover>
      <div class="insert-handler-item" v-tooltip="'InsertLaTeX'" @click="latexEditorVisible = true">
        <i-icon-park-outline:formula class="icon" /> <span class="text">LaTeX</span>
      </div>
      <Popover trigger="click" v-model:value="mediaInputVisible" :offset="10">
        ...
        <div class="insert-handler-item" v-tooltip="'Insert Audio/Video'">
          <i-icon-park-outline:video-two class="icon" /> <span class="text">Audio/Video</span>
        </div>
      </Popover>
      <div class="insert-handler-item" :class="{ 'active': showSymbolPanel }" v-tooltip="'InsertSymbols'" @click="toggleSymbolPanel()">
        <i-icon-park-outline:symbol class="icon" /> <span class="text">Symbols</span>
      </div>
    </div>

    <div class="right-handler">
      <span class="handler-item viewport-size" v-tooltip="'Zoom Out Canvas (Ctrl + -)'" @click="scaleCanvas('-')">
      ...
      <span class="handler-item viewport-size" v-tooltip="'Zoom In Canvas (Ctrl + =)'" @click="scaleCanvas('+')">
