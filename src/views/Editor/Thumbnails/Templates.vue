<template>
  <div class="templates">
    ...
    <div class="content" v-loading="{ state: loading, text: 'Loading...' }">
      <div class="header">
        <div class="types">
          <div class="type" 
        ...
        <div class="insert-all" @click="insertTemplates({ slides, theme })">InsertAll</div>
      </div>
      <div class="list" ref="listRef">
        <template v-for="slide in slides" :key="slide.id">
          ...
          >
            ...
            <div class="btns">
              <Button class="btn" type="primary" size="small" @click="insertTemplate(slide)">InsertTemplate</Button>
            </div>
          </div>
        </template>
      </div>
