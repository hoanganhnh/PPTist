    ...
    <div class="configs">
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreWebfont" v-tooltip="'Online fonts are ignored by default during export. If you use online fonts in your slides and want to preserve the style after export, uncheck the Ignore Online Fonts option. Note that this will increase export time.'" />
        </div>
      </div>
    </div>
