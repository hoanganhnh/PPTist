    ...
    <div class="configs">
      <div class="row">
        ...
        >
          ...
          <RadioButton style="width: 50%;" value="current">Current Slide</RadioButton>
        </RadioGroup>
      </div>
      <div class="row">
        <div class="title">Slides per Page:</div>
        <Select 
          class="config-item"
          v-model:value="count"
          :options="[
      ...
      <div class="row">
        <div class="title">Edge Margin:</div>
        <div class="config-item">
          <Switch v-model:value="padding" />
        </div>
      </div>
      <div class="tip">
        Tip: In the print dialog, check the "Background Graphics" option and set margins to "Default".
      </div>
    </div>

    <div class="btns">
      <Button class="btn export" type="primary" @click="expPDF()"><i-icon-park-outline:download /> Print / Export PDF</Button>
