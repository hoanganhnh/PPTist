    ...
    <div class="configs">
      <div class="row">
        ...
        >
          ...
          <RadioButton style="width: 33.33%;" value="current">Current Slide</RadioButton>
      ...
      <template v-if="exportMode === 'standard'">
        <div class="row">
          ...
          <div class="config-item">
            <Switch v-model:value="ignoreMedia" v-tooltip="'Audio and video are ignored by default during export. If your slides contain audio/video elements and you want to include them in the PPTX file, uncheck the Ignore Audio/Video option. Note that this will significantly increase export time.'" />
          </div>
        </div>
        <div class="row">
