<template>
  <div class="multi-position-panel">
    <ButtonGroup class="row">
      <Button style="flex: 1;" v-tooltip="'Left'" @click="alignElement(ElementAlignCommands.LEFT)"><i-icon-park-outline:align-left /></Button>
      ...
      <Button style="flex: 1;" v-tooltip="'Right'" @click="alignElement(ElementAlignCommands.RIGHT)"><i-icon-park-outline:align-right /></Button>
    </ButtonGroup>
    <ButtonGroup class="row">
...
// Align multiple elements, check state first:
// If selected elements form a single group, align it to the canvas;
// If elements are ungrouped or from different groups, align them relative to each other.
