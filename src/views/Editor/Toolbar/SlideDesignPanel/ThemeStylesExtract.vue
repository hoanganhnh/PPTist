  ...
  <div class="theme-styles-extract">
    ...
    <div class="content">
      ...
      <div class="config-item" v-if="themeStyles.themeColors.length">
        <div class="label">Theme Color:<span class="tip">(Click color blocks to exclude unwanted colors)</span></div>
    ...
    <div class="btns">
      <Button class="btn" type="primary" @click="updateAllThemes()"><i-icon-park-outline:check /> Save Selected Config as Theme</Button>
    </div>
  </div>
</template>
...
const tabs: TabItem[] = [
  { key: 'single', label: 'Extract from Current Slide' },
...
const updateAllThemes = () => {
  ...
  if (themeColors.length > 6) {
    ...
    message.warning('Theme colors exceeded the limit, the first 6 have been automatically selected')
  }
