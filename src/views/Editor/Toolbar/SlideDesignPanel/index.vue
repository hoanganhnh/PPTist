  ...
  <div class="slide-design-panel">
    ...
    <div class="row">
      ...
      <Select 
        ...
        :options="[
          ...
          { label: 'Zoom to Fill', value: 'cover' },
        ]"
      />
    ...
    <template v-if="moreThemeConfigsVisible">
      ...
      <div class="row" style="height: 30px;">
        <div style="width: 40%;">HorizontalShadow：</div>
        <Slider 
          style="width: 60%;"
          :min="-10" 
          :max="10" 
      ...
      <div class="row" style="height: 30px;">
        <div style="width: 40%;">VerticalShadow：</div>
        <Slider
          style="width: 60%;"
          :min="-10"
          :max="10"
    ...
    <div class="row">
      <Button style="flex: 1;" @click="themeStylesExtractVisible = true"><i-icon-park-outline:platte /> Extract Theme from Slides</Button>
    </div>
    ...
    <div class="theme-list">
      ...
      >
        <div class="theme-item-content">
          ...
          <div class="btns">
            <Button type="primary" size="small" @click="applyPresetTheme(item)">Settings</Button>
            <Button type="primary" size="small" style="margin-top: 3px;" @click="applyPresetTheme(item, true)">Set & Apply</Button>
          </div>
        </div>
      </div>
    </div>
...
// Set background mode: solid color, image, or gradient
