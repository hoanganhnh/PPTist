<template>
  <div class="multi-style-panel">
    <div class="row">
      <div style="width: 40%;">FillColor：</div>
    ...
    >
      <RadioButton value="left" style="flex: 1;" v-tooltip="'Left'"><i-icon-park-outline:align-text-left /></RadioButton>
      <RadioButton value="center" style="flex: 1;" v-tooltip="'Center'"><i-icon-park-outline:align-text-center /></RadioButton>
      <RadioButton value="right" style="flex: 1;" v-tooltip="'Right'"><i-icon-park-outline:align-text-right /></RadioButton>
      <RadioButton value="justify" style="flex: 1;" v-tooltip="'Justify'"><i-icon-park-outline:align-text-both /></RadioButton>
    </RadioGroup>
  </div>
</template>
...
// Batch edit fill colors (cell fills for tables, icon colors for audio)
