<template>
  <div class="table-style-panel">
    ...
    >
      <RadioButton value="left" v-tooltip="'Left'" style="flex: 1;"><i-icon-park-outline:align-text-left /></RadioButton>
      <RadioButton value="center" v-tooltip="'Center'" style="flex: 1;"><i-icon-park-outline:align-text-center /></RadioButton>
      <RadioButton value="right" v-tooltip="'Right'" style="flex: 1;"><i-icon-park-outline:align-text-right /></RadioButton>
    ...
    >
      <RadioButton value="top" v-tooltip="'Top Align'" style="flex: 1;"><i-icon-park-outline:align-text-top-one /></RadioButton>
      <RadioButton value="middle" v-tooltip="'Center'" style="flex: 1;"><i-icon-park-outline:align-text-middle-one /></RadioButton>
      <RadioButton value="bottom" v-tooltip="'Bottom Align'" style="flex: 1;"><i-icon-park-outline:align-text-bottom-one /></RadioButton>
    </RadioGroup>
    ...
    <div class="row">
      <div style="width: 40%;">Row Operations:</div>
      <ButtonGroup style="width: 60%;" passive>
        <Button first style="flex: 1;" @click="emitTableCommand('insert-row', 'after')">Add Row</Button>
        <Popover trigger="click">
          <template #content>
            <PopoverMenuItem center @click="emitTableCommand('insert-row', 'before')">Add Above</PopoverMenuItem>
            <PopoverMenuItem center @click="emitTableCommand('insert-row', 'after')">Add Below</PopoverMenuItem>
            <PopoverMenuItem center @click="emitTableCommand('delete-row')">Delete Row</PopoverMenuItem>
          </template>
    ...
    <div class="row">
      <div style="width: 40%;">Column Operations:</div>
      <ButtonGroup style="width: 60%;" passive>
        <Button first style="flex: 1;" @click="emitTableCommand('insert-col', 'after')">Add Column</Button>
        <Popover trigger="click">
          <template #content>
            <PopoverMenuItem center @click="emitTableCommand('insert-col', 'before')">Add Left</PopoverMenuItem>
            <PopoverMenuItem center @click="emitTableCommand('insert-col', 'after')">Add Right</PopoverMenuItem>
            <PopoverMenuItem center @click="emitTableCommand('delete-col')">Delete Column</PopoverMenuItem>
          </template>
          <Button last class="popover-btn"><i-icon-park-outline:down /></Button>
        </Popover>
      </ButtonGroup>
    ...
    <div class="row theme-switch">
      <div style="width: 40%;">EnableThemeTable：</div>
    ...
    <template v-if="theme">
      ...
      <div class="row">
        <div style="width: 40%;">ThemeColor：</div>
...
// Update active cell text formatting status
...
// Update table style properties (header, footer, columns, color)
