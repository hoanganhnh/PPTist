<template>
  <div class="image-style-panel">
    ...
    <ButtonGroup class="row" passive>
      <Button first style="width: calc(100% - 32px);" @click="clipImage()"><i-icon-park-outline:tailoring /> CropImage</Button>
    ...
    <FileInput @change="files => replaceImage(files)">
      <Button class="full-width-btn"><i-icon-park-outline:transform /> ReplaceImage</Button>
    </FileInput>
    <Button class="full-width-btn" @click="resetImage()"><i-icon-park-outline:undo /> ResetStyle</Button>
...
// Get original image size and coordinates
const getImageElementDataBeforeClip = () => {
  const _handleElement = handleElement.value as PPTImageElement

  // Image current size/position and crop range
