<template>
  <div class="video-style-panel">
    <div class="title">VideoPreviewCover</div>
    ...
    <div class="row" v-if="handleVideoElement.poster">
      <Button style="flex: 1;" @click="updateVideo({ poster: '' })"><i-icon-park-outline:undo /> ResetCover</Button>
    </div>
...
// Fetch video first frame as preview cover
