    ...
    <div class="element-animation" v-if="handleElement">
      ...
      >
        ...
        <Button class="element-animation-btn" @click="handleAnimationId = ''">
          <i-icon-park-outline:effects /> AddAnimation
        </Button>
      </Popover>
    </div>
            ...
            <div class="config-item">
              ...
              <Select
                ...
                :options="[
                  ...
                  { label: 'With Previous Animation', value: 'meantime' },
                  { label: 'After Previous Animation', value: 'auto' },
                ]"
              />
            </div>
            <div class="config-item">
              <Button style="width: 100%;" @click="openAnimationPool(element.id)"><i-icon-park-outline:switch /> ChangeAnimation</Button>
            </div>
          </div>
        </div>
      </template>
...
// Current slide's animation list
...
// Current element entrance animation configuration
...
// Modify element animation and preview once
...
// Add element animation and preview once
...
// Remove mask 600ms after opening animation panel to prevent preview jitter when cursor enters quickly
