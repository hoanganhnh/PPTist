...
/**
 * Calculate radians of a line from origin to a given point
 * @param x Pointx
 * @param y Pointy
 */
...
export default (
  ...
  const rotateElement = (e: MouseEvent | TouchEvent, element: Exclude<PPTElement, PPTChartElement | PPTLineElement | PPTVideoElement | PPTAudioElement>) => {
    ...
    const handleMousemove = (e: MouseEvent | TouchEvent) => {
      ...
      // Calculate angle (radians) of cursor position relative to element center
      ...
      // Snap rotation angle when close to multiples of 45 degrees
