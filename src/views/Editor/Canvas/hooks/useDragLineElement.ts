...
export default (elementList: Ref<PPTElement[]>) => {
  ...
  const dragLineElement = (e: MouseEvent, element: PPTLineElement, command: OperateLineHandlers) => {
    ...
    // Get the 8 resize points of unrotated elements (except lines) as snap targets
    ...
    document.onmousemove = e => {
      ...
      // Coordinates of line start and end points in the editing area
      ...
      // Position of dragged start or end point
      ...
      // Calculate start/end point offsets relative to line coordinates
