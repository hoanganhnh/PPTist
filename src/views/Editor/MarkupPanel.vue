<template>
  ...
  >
    <div class="container">
      <div class="row">
        <div style="width: 40%;">Current Slide Type:</div>
        <Select
          style="width: 60%;"
          :value="slideType"
      ...
      <div class="placeholder" v-else>Select an image, text, or shape with text to mark type</div>
    </div>
  </MoveablePanel>
</template>
...
const slideTypeOptions = ref<{ label: string; value: SlideType | '' }[]>([
  ...
  { label: 'Cover Slide', value: 'cover' },
  { label: 'Table of Contents Slide', value: 'contents' },
  { label: 'Transition Slide', value: 'transition' },
  { label: 'Content Slide', value: 'content' },
  { label: 'Ending Slide', value: 'end' },
])
...
const imageTypeOptions = ref<{ label: string; value: ImageType | '' }[]>([
  { label: 'Unknown Type', value: '' },
  { label: 'Slide Illustration', value: 'pageFigure' },
