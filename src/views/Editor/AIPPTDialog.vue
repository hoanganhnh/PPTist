<template>
  <div class="aippt-dialog">
    <div class="header">
      ...
      <span class="subtite" v-if="step === 'template'">Pick a template below to generate PPT, or<span class="local" v-tooltip="'Upload .pptist format template file'" @click="uploadLocalTemplate()">Use Local Template</span></span>
      <span class="subtite" v-else-if="step === 'outline'">Confirm the content outline below (click to edit content, right-click to add/delete outline items), then select a template to start</span>
      <span class="subtite" v-else>Enter your PPT topic below, and optionally add details such as industry, position, subject, or purpose</span>
    </div>
        ...
        <div class="config-item">
          ...
          <Select
            ...
            :options="[
              ...
              { label: 'Business Style', value: 'Business Style' },
        ...
        <div class="config-item">
          ...
          <Select
            ...
            :options="[
              ...
              { label: 'AI Image Search', value: 'ai-search', disabled: true },
              { label: 'AI Image Generation', value: 'ai-create', disabled: true },
            ]"
          />
        </div>
      </div>
    ...
    <div class="preview" v-if="step === 'outline'">
      ...
      <div class="btns" v-if="!outlineCreating">
        ...
        <Button class="btn" @click="outline = ''; step = 'setup'">Back to Regenerate</Button>
      </div>
    </div>
    <div class="select-template" v-if="step === 'template'">
      ...
      <div class="btns">
        ...
        <Button class="btn" @click="step = 'outline'">BackOutline</Button>
      </div>
    </div>
